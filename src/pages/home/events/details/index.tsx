...
const EventsDetails = () => {
  return (
    <section className="flex min-h-[calc(100vh-326px)] justify-center md:min-h-[calc(100vh-73px)]">
      <div className="font-inter flex w-full max-w-300 flex-col gap-6 pt-6">
...
const InviteStats = () => {
  return (
    <div className="flex justify-between rounded-[12px] border border-[#0000001A] [&>div]:flex [&>div]:basis-full [&>div]:flex-col [&>div]:gap-3 [&>div]:border-r [&>div]:border-[#0000001A] [&>div]:p-4 [&>div]:last:border-r-0">
      <div>
